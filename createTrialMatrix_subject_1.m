function session = createTrialMatrix_subject_1(initials, varargin)
...
% Create pseudo-random array of movies and respective stimulus sizes
%-------------------------------------------------------------------------%
...
%%% manually select movies and randomize
% real experiment
naturalMovies       = [5,6,4];
syntheticMovies     = [50,60,40];

natSizes            = [1,2,3];
synSizes            = [1,2,3];
%%% pseudorandomly assign sizes to movies
% make sure participant will view each size at least once 
