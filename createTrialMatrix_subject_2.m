function session = createTrialMatrix_subject_2(initials, varargin)
...
naturalMovies       = [4,5,6];%naturalIDs(movieOrder)';
syntheticMovies     = [40,50,60];%syntheticIDs(movieOrder)';
